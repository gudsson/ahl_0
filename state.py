...
#     state = GameState()
#     state.event_check({ 'event': 'PENALTY', 'team': 'home', 'player_number': 27, 'pim': 2, 'time': '19:59', 'period': 3, 'game_type': 'Regular'})
#     state.event_check({ 'event': 'PERIOD END', 'period': 3, 'game_type': 'Regular'})
#     state.event_check({ 'event': 'PERIOD START', 'period': 4, 'game_type': 'Regular'})
#     state.event_check({ 'event': 'PENALTY', 'team': 'home', 'player_number': 28, 'pim': 2, 'time': '00:01', 'period': 4, 'game_type': 'Regular'})
#     state.event_check({ 'event': 'PENALTY', 'team': 'away', 'player_number': 29, 'pim': 2, 'time': '00:02', 'period': 4, 'game_type': 'Regular' })

#     # print(states.manpower)
#     # for team in states.active_penalties:
#     #     for penalty in states.active_penalties[team]:
#     #         print(penalty)
#     state.event_check({ 'event': 'SHOT', 'team': 'away', 'time': '1:01', 'period': 4, 'game_type': 'Regular'})
#     state.event_check({ 'event': 'GOAL', 'team': 'away', 'time': '1:02', 'period': 4, 'game_type': 'Regular'})
#     state.event_check({ 'event': 'GOAL', 'team': 'away', 'time': '3:02', 'period': 4, 'game_type': 'Regular'}) 
#     # for team in states.active_penalties:
#     #     for penalty in states.active_penalties[team]:
#     #         print(penalty)
